...
Created by `setup.sh`:
  ...
  File                       Type                                        Purpose
  -------------------------  ------------------------------------------  ---------------------------
  vacation/photo1.jpg        JPEG, EXIF 2024-03-15                       Photo with date, meaningful source dir
  ...
  music/song1.mp3            MP3, 15s, ID3: Beatles/Abbey Road/Come ..   Audio with tags
  music/song2.mp3            MP3, 15s, ID3: Beatles/Abbey Road/Some..    Audio with tags
...
### Core workflow
  ...
  2   import --dry-run   Dry-run prevents writes             No files in targets
  3   import (copy)      Full pipeline: scan, classify,     2 photos in YYYY/YYYY-MM_topic/,
                         extract metadata, dedup, copy,     1 video, 3 audio in Artist/Album/,
                         DB insert                          6 DB records, dupes/hidden skipped
...
### Filtering
  ...
  7   --exclude-dir DAW* Directory pattern exclusion        DAW_Project/ contents skipped
...
### Configuration
  ...
  16  CLI overrides      --images-target vs config value    CLI value takes precedence
